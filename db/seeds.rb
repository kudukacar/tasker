...
TaskerCat.create(category_id: 1, user_id: 2, hourly_rate: 47, skills_description: "Over 20 years experience moving")
TaskerCat.create(category_id: 1, user_id: 3, hourly_rate: 55, skills_description: "Moved all my life")
TaskerCat.create(category_id: 2, user_id: 4, hourly_rate: 50, skills_description: "Over 20 years experience putting together furniture")
TaskerCat.create(category_id: 2, user_id: 5, hourly_rate: 45, skills_description: "Put together furniture all my life")
TaskerCat.create(category_id: 3, user_id: 6, hourly_rate: 30, skills_description: "Over 20 years experience mounting")
TaskerCat.create(category_id: 3, user_id: 7, hourly_rate: 35, skills_description: "Mounting all my life")
TaskerCat.create(category_id: 4, user_id: 8, hourly_rate: 60, skills_description: "Over 20 years experience with home improvement")
TaskerCat.create(category_id: 4, user_id: 9, hourly_rate: 65, skills_description: "Been doing home improvement my entire life")
TaskerCat.create(category_id: 5, user_id: 10, hourly_rate: 25, skills_description: "Over 20 years experience cleaning")
TaskerCat.create(category_id: 5, user_id: 11, hourly_rate: 28, skills_description: "Been cleaning my entire life")
TaskerCat.create(category_id: 6, user_id: 12, hourly_rate: 50, skills_description: "Over 20 years experience being a handyman")
TaskerCat.create(category_id: 6, user_id: 13, hourly_rate: 55, skills_description: "I've been a handyman my entire life")
TaskerCat.create(category_id: 7, user_id: 14, hourly_rate: 40, skills_description: "Over 20 years experience lifting heavy items")
TaskerCat.create(category_id: 7, user_id: 15, hourly_rate: 45, skills_description: "Been lifting heavy items my entire life")
TaskerCat.create(category_id: 8, user_id: 16, hourly_rate: 25, skills_description: "Over 20 years experience delivering items")
TaskerCat.create(category_id: 8, user_id: 17, hourly_rate: 30, skills_description: "Been delivering my entire life")
TaskerCat.create(category_id: 9, user_id: 18, hourly_rate: 60, skills_description: "Over 20 years experience with yard work")
TaskerCat.create(category_id: 9, user_id: 19, hourly_rate: 65, skills_description: "Done yard work my entire life")
TaskerCat.create(category_id: 10, user_id: 20, hourly_rate: 50, skills_description: "Over 20 years experience as a personal assistant")
TaskerCat.create(category_id: 10, user_id: 21, hourly_rate: 45, skills_description: "Been a personal assistant my entire life")
TaskerCat.create(category_id: 11, user_id: 22, hourly_rate: 60, skills_description: "Over 20 years experience packing and unpacking")
TaskerCat.create(category_id: 11, user_id: 23, hourly_rate: 65, skills_description: "Been packing and unpacking my entire life")
TaskerCat.create(category_id: 12, user_id: 24, hourly_rate: 60, skills_description: "Over 20 years experience painting")
TaskerCat.create(category_id: 12, user_id: 25, hourly_rate: 55, skills_description: "Been painting my entire life")
TaskerCat.create(category_id: 13, user_id: 26, hourly_rate: 70, skills_description: "Over 20 years experience as a plumber")
TaskerCat.create(category_id: 13, user_id: 27, hourly_rate: 75, skills_description: "Been a plumber my entire life")
TaskerCat.create(category_id: 14, user_id: 28, hourly_rate: 80, skills_description: "Over 20 years experience as an electrician")
TaskerCat.create(category_id: 14, user_id: 29, hourly_rate: 85, skills_description: "Been an electrician my entire life")
TaskerCat.create(category_id: 15, user_id: 30, hourly_rate: 30, skills_description: "Over 20 years experience deep cleaning")
TaskerCat.create(category_id: 15, user_id: 31, hourly_rate: 35, skills_description: "I've been deep cleaning my entire life")
TaskerCat.create(category_id: 16, user_id: 32, hourly_rate: 40, skills_description: "Over 20 years experience organizing")
TaskerCat.create(category_id: 16, user_id: 33, hourly_rate: 35, skills_description: "I've been organized my entire life")
TaskerCat.create(category_id: 17, user_id: 34, hourly_rate: 50, skills_description: "Over 20 years experience with event staffing")
TaskerCat.create(category_id: 17, user_id: 35, hourly_rate: 55, skills_description: "I've staffed events my entire life")
TaskerCat.create(category_id: 18, user_id: 36, hourly_rate: 25, skills_description: "Over 20 years experience running errands")
TaskerCat.create(category_id: 18, user_id: 37, hourly_rate: 30, skills_description: "I've run errands my entire life")
TaskerCat.create(category_id: 19, user_id: 38, hourly_rate: 70, skills_description: "Over 20 years experience as a carpenter")
TaskerCat.create(category_id: 19, user_id: 39, hourly_rate: 75, skills_description: "I've been a carpenter my entire life")
